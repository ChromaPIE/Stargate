...
发现陨石后便要向其中心挖掘。在那里能找到刻定石英簇、刻定石英芽、各种类型的[刻定石英母岩](items-blocks-machines/budding_certus.md)，以及一个神秘方块。

挖下所有找到的刻定石英簇和刻定石英块。也可以采集刻定石英母岩，但在没有精准采集时会降一级。
