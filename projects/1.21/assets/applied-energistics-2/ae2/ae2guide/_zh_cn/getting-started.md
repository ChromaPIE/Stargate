...
发现陨石后便要向其中心挖掘。在那里能找到刻定石英簇、刻定石英芽、各种类型的[刻定石英母岩](items-blocks-machines/budding_certus.md)、一个神秘方块。

挖下找到的所有刻定石英簇和刻定石英块。也可以采集刻定石英母岩，但在没有精准采集时掉落的母岩会降一级。

不要破坏任何无瑕的刻定石英母岩，在有精准采集的情况下它们也会降级为有瑕的刻定石英母岩，并且不可能将其修复回去。
...
每次石英芽生长时，母岩都有可能降一级，并最终变为普通的刻定石英块。将刻定石英母岩或者刻定石英块以及若干个<ItemLink id="charged_certus_quartz_crystal" />一起投入水中，就能进行修复并产生新的母岩。
...
另一种所需材料是伏流，你应该已经在制造晶体催生器的过程中见过它了。将充能刻定石英水晶、红石、下界石英投入水中就能制成伏流。这一流程的自动化则“[留给读者作为习题](example-setups/processor-automation.md)”。
